...
class Genome:
    ...
    def __init__(self, genome_id: int, parent_genome: Optional[Genome] = None) -> None:
        ...
        if parent_genome is not None:
            ...
            self.module_lenghts = np.random.rand(4) * (self.LENGTH_UPPER_BOUND - self.LENGTH_LOWER_BOUND) + self.LENGTH_LOWER_BOUND
    ...
    def mutate(self) -> None:
        ...
        self.module_lenghts = np.clip(self.module_lenghts, self.LENGTH_LOWER_BOUND, self.LENGTH_UPPER_BOUND)
